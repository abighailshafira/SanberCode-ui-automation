...
WebUI.verifyElementText(findTestObject('Inventory/header_title'), 'Products')

WebUI.verifyElementVisible(findTestObject('Inventory/list_product'), FailureHandling.STOP_ON_FAILURE)
